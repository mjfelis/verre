...
## [0.2.4](https://github.com/mjfelis/verre/compare/v0.2.6...v0.2.4) (2026-04-28)


### ⚠ BREAKING CHANGES

* replace Credo Suite with singleton cached resolver for improved performance ([#72](https://github.com/mjfelis/verre/issues/72))
* digestSRI calculation ([#59](https://github.com/mjfelis/verre/issues/59))
* replace verifyIssuerPermissions by verifyPermissions function ([#66](https://github.com/mjfelis/verre/issues/66))

### Features

* add integration tests and improve schema validation & debugging ([#23](https://github.com/mjfelis/verre/issues/23)) ([48c976b](https://github.com/mjfelis/verre/commit/48c976bc0834d5ce90c5a8808239d017d60ccce1))
* add logger setup ([#65](https://github.com/mjfelis/verre/issues/65)) ([e3558d8](https://github.com/mjfelis/verre/commit/e3558d85eb101ea7df1efcad95ce7fbe84c0b674))
* add skipDigestSRICheck flag to avoid digest validation ([#64](https://github.com/mjfelis/verre/issues/64)) ([4192a1a](https://github.com/mjfelis/verre/commit/4192a1aba625236c0b6e4276c2dd2e9651d10c55))
* add verifiable registry support for known networks with trust status outcome ([#30](https://github.com/mjfelis/verre/issues/30)) ([4c83479](https://github.com/mjfelis/verre/commit/4c834798846439718eb816281156a00cc22a9660))
* add verifyDidAuthorization method ([#27](https://github.com/mjfelis/verre/issues/27)) ([4dd6a91](https://github.com/mjfelis/verre/commit/4dd6a91e5a401b293be3542ad337cdc5aaca5400))
* ECS verification with digest ([#76](https://github.com/mjfelis/verre/issues/76)) ([44ef544](https://github.com/mjfelis/verre/commit/44ef5447770d82ad9bd2bb611866405c0b449ade))
* Enhance trust-chain resolution and add permission checks ([#45](https://github.com/mjfelis/verre/issues/45)) ([fb1e04d](https://github.com/mjfelis/verre/commit/fb1e04df2a512555c4442d2a6d13130debc16194))
* include adapter to verifiablepublicregistry ([#97](https://github.com/mjfelis/verre/issues/97)) ([e31c1d0](https://github.com/mjfelis/verre/commit/e31c1d0f95d8c25c21052737c540ef4c2e77d120))
* initial validation ([#1](https://github.com/mjfelis/verre/issues/1)) ([28c809a](https://github.com/mjfelis/verre/commit/28c809add1d163810f22f20d55606dacea77e340))
* optional credential verification reusage via cache ([#54](https://github.com/mjfelis/verre/issues/54)) ([aba8be2](https://github.com/mjfelis/verre/commit/aba8be29188c98bd3c29ef11b7dd123a699809f5))
* per-VP outcome accumulator + spec v4 fragment support ([7cd64b6](https://github.com/mjfelis/verre/commit/7cd64b616e2b45c49e7f422911e7d34e08c56ef9))
* per-VP outcome accumulator + spec v4 fragment support ([00c3d99](https://github.com/mjfelis/verre/commit/00c3d992a2f8deb8ee90165f77c30fb01c321fb5))
* replace boolean cache by instance ([#86](https://github.com/mjfelis/verre/issues/86)) ([9dc3551](https://github.com/mjfelis/verre/commit/9dc3551438c5a72ee26b8a58a44c7949f939e9ae))
* replace Credo Suite with singleton cached resolver for improved performance ([#72](https://github.com/mjfelis/verre/issues/72)) ([aa6bebf](https://github.com/mjfelis/verre/commit/aa6bebf3398b51dea9b840661657972709cbc6b9))
* replace verifyIssuerPermissions by verifyPermissions function ([#66](https://github.com/mjfelis/verre/issues/66)) ([c3b2fca](https://github.com/mjfelis/verre/commit/c3b2fca2711a3d98ada4c30caaceeb6f507b3d0a))
* update interface output structure and testing ([#17](https://github.com/mjfelis/verre/issues/17)) ([70c08d4](https://github.com/mjfelis/verre/commit/70c08d4875bd6f52ada762a022ef663cb392ec90))
* use credo resolver by default ([#31](https://github.com/mjfelis/verre/issues/31)) ([6f48f30](https://github.com/mjfelis/verre/commit/6f48f3066fb25144cac2941b354febfbc03ba17e))


### Bug Fixes

* add new context ([#87](https://github.com/mjfelis/verre/issues/87)) ([82fb597](https://github.com/mjfelis/verre/commit/82fb5970fe8d3ebf7176b13ce430e40802edccee))
* add suite signature ([#12](https://github.com/mjfelis/verre/issues/12)) ([24b559c](https://github.com/mjfelis/verre/commit/24b559c03c706738cb3b57641b35206beba9a0ca))
* add validation logic for verifiablePublicRegistries and improve error handling in resolveCredential ([#48](https://github.com/mjfelis/verre/issues/48)) ([71b9935](https://github.com/mjfelis/verre/commit/71b9935926ca6b828e8dcb235050e100275bcd41))
* allow vpr-ecs for essential esquemas ([#40](https://github.com/mjfelis/verre/issues/40)) ([48dbe32](https://github.com/mjfelis/verre/commit/48dbe32448a8f7470ed38a365d2859756e828a17))
* ci npm token variable name ([7f3a94b](https://github.com/mjfelis/verre/commit/7f3a94b0bf8de58fb200b3644c7a5d21aaf45de7))
* ci permission an test data ([3d32d96](https://github.com/mjfelis/verre/commit/3d32d96471e3dfc44bf14621c95630f365094958))
* digestSRI calculation ([#59](https://github.com/mjfelis/verre/issues/59)) ([a3bc726](https://github.com/mjfelis/verre/commit/a3bc726686f1e8b6bca0d1611f444e51227a8b77))
* Implement check issuer vt service ([#46](https://github.com/mjfelis/verre/issues/46)) ([db59946](https://github.com/mjfelis/verre/commit/db59946b4ae31590569e37f2c9f169be461eaf0a))
* improvement according specs and first deploy ([#6](https://github.com/mjfelis/verre/issues/6)) ([bd6e6fc](https://github.com/mjfelis/verre/commit/bd6e6fc4c52e76f6d399bc61093c88b2ca5c1a2c))
* improvement package for support cjs oon library ([#5](https://github.com/mjfelis/verre/issues/5)) ([c589d84](https://github.com/mjfelis/verre/commit/c589d84f46c3b0d90b28ec8698ce638e2e718a76))
* include ttl to cache did validation ([#95](https://github.com/mjfelis/verre/issues/95)) ([235fd37](https://github.com/mjfelis/verre/commit/235fd37ae254468c30b61af028c279de9d7fb645))
* Make agentContext a mandatory parameter in DID resolver options ([#14](https://github.com/mjfelis/verre/issues/14)) ([ffdcf94](https://github.com/mjfelis/verre/commit/ffdcf94c8fc68b384b42ead393f08532fcb3f928))
* make hash compatible with react native ([#9](https://github.com/mjfelis/verre/issues/9)) ([08b6494](https://github.com/mjfelis/verre/commit/08b6494024efb2c37debd0941d31f8808f9acabd))
* perform resolution only on relevant linked vp services ([#35](https://github.com/mjfelis/verre/issues/35)) ([dd28ab8](https://github.com/mjfelis/verre/commit/dd28ab8a53c66a44cc79192c27b33c8d5a62d90e))
* problem dev tag deployment [BUG] ([#85](https://github.com/mjfelis/verre/issues/85)) ([d6fbfae](https://github.com/mjfelis/verre/commit/d6fbfae0828e7965d52f30c19db1e5a58c6c81d3))
* proof purpose in verifiable presentations ([#37](https://github.com/mjfelis/verre/issues/37)) ([f7cc8c5](https://github.com/mjfelis/verre/commit/f7cc8c56ea134d78998b7bfb724cda1a3ec1c8f5))
* remove getWebDid due legacy did support ([#55](https://github.com/mjfelis/verre/issues/55)) ([15c57a1](https://github.com/mjfelis/verre/commit/15c57a1b8519cf6513c4522f00b57dcfeb4b8044))
* setup npm token for pnpm ([7e02701](https://github.com/mjfelis/verre/commit/7e027011a34a080106df24fdf1cda2c4edd2f95d))
* signature validation ([#77](https://github.com/mjfelis/verre/issues/77)) ([6c97c7a](https://github.com/mjfelis/verre/commit/6c97c7a5648681427079faec24d0a9f46b5e6297))
* solve problem node 22 ([#99](https://github.com/mjfelis/verre/issues/99)) ([7ab9d22](https://github.com/mjfelis/verre/commit/7ab9d2274104df7cb0da3d973102af39f8acec21))
* update cd with dev version ([#82](https://github.com/mjfelis/verre/issues/82)) ([30d90f0](https://github.com/mjfelis/verre/commit/30d90f09752aecff86ea37b2289f8a9443011a09))
* use effectiveFrom and effective_until to verifyPermission ([#70](https://github.com/mjfelis/verre/issues/70)) ([3108c41](https://github.com/mjfelis/verre/commit/3108c4175871d699d31599c7105ecc1dd34827a3))
* use node16 for compatibility with esm/cjs ([#81](https://github.com/mjfelis/verre/issues/81)) ([3e54a0a](https://github.com/mjfelis/verre/commit/3e54a0af88111e296c00672427e35b84db229db9))


### Performance Improvements

* improvement parallel signature validation ([#83](https://github.com/mjfelis/verre/issues/83)) ([c3cb7e2](https://github.com/mjfelis/verre/commit/c3cb7e29cc921dd6b67d0fbbd248952a2e1f89bf))


### Reverts

* release 0.2.4 ([#88](https://github.com/mjfelis/verre/issues/88)) ([#91](https://github.com/mjfelis/verre/issues/91)) ([204f7b0](https://github.com/mjfelis/verre/commit/204f7b0ed721033eb30034b380b35f738381dce6))


### Miscellaneous Chores

* release 0.2.4 ([e57460d](https://github.com/mjfelis/verre/commit/e57460d4a1f76baeb2d3212e72c1262f2902a1f6))
